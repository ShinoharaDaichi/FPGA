...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../blinker.sopcinfo
...
# CPU Name 
# setting CPU_NAME is nios2_proc
CPU_NAME = nios2_proc
...
# The SOPC System ID 
# setting SOPC_SYSID is 4919
SOPC_SYSID_FLAG += --id=4919
ELF_PATCH_FLAG  += --id 4919

# The SOPC System ID Base Address 
# setting SOPC_SYSID_BASE_ADDRESS is 0x4001020
SOPC_SYSID_FLAG += --sidp=0x4001020
ELF_PATCH_FLAG  += --sidp 0x4001020

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1450354534
SOPC_SYSID_FLAG += --timestamp=1450354534
ELF_PATCH_FLAG  += --timestamp 1450354534
